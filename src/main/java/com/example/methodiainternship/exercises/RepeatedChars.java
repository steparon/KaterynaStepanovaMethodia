...
public class RepeatedChars {
    ...
    /* Задача номер 4.
    В тази задача добавям чарове от стринга в ХашМап, където ключ - е чар, а стойност е интеджер.
    Всеки път, когато добавяме двойка с ключ, който вече е добавен (когато чар се повтаря), стойността се увеличава с 1.
    Така знаем, че ако стойност е повече от 1, чар се повтаря.
